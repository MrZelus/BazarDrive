...
Спасибо за вклад в BazarDrive.

Этот документ описывает **общие правила участия в проекте**, а не только отдельный Epic или UI-срез. Используйте его как базовый guide для:
- локального запуска,
...
Основной bot flow:
- `app/bot/handlers.py`
- дополнительные bot-модули: `app/bot/**`
