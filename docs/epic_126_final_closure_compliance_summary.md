...
|---|---|---|
| 1) Tokens centralized and used consistently | ✅ Done | `docs/epic_126_p0_theme_token_inventory_drift_report.md`; `docs/theme-contract.md`; feed-path replacements in `guest_feed.html`, `web/css/feed.css`, `web/js/feed.js` |
| 2) Stable contrast on Feed/Rules/Profile | ✅ Done | `docs/epic_126_p0_contrast_stabilization_gate.md`; `docs/epic_126_p1_7_regression_findings_resolution.md`; token-aligned state/contrast updates in feed path |
...
| 4) Regression visual procedure exists | ✅ Done | `docs/epic_126_p1_visual_regression_checklist_runbook.md`; `docs/epic_126_p1_visual_regression_run_report_sample.md` |
