    ...
    const docs = [
      ...
      },
      {
        ...
        title: 'Правила заказа такси для пассажира',
        description: 'Практичные рекомендации, которые помогают безопасно и без лишних рисков оформить поездку.',
        tags: ['пассажир', 'безопасность', 'заказ', 'маршрут', 'тариф', 'поддержка'],
        type: 'Памятка',
        summary: 'Проверяйте адрес, тариф и данные машины, а при проблемах сразу фиксируйте ситуацию и обращайтесь в поддержку.',
        sections: [
          {
            title: 'Базовые правила заказа такси пассажиром',
            orderedItems: [
              'Указывайте точный адрес подачи: ставьте точку на карте у подъезда или входа, а не «примерно рядом».',
              'Проверяйте маршрут и тариф до заказа: смотрите ориентировочную цену, платные дороги и время в пути.',
              'Пишите важные детали в комментарии: например, «подъезд 3», «въезд через шлагбаум», «с ребёнком».',
              'Выбирайте подходящий класс авто: при большом багаже, животных или детском кресле включайте нужные опции заранее.',
              'Будьте на месте к моменту подачи: учитывайте бесплатное время ожидания и последующую плату за простой.',
              'Сверяйте машину перед посадкой: номер, марка, цвет и имя водителя в приложении должны совпадать.',
              'Не передавайте лишние персональные данные: водителю обычно достаточно информации из заказа.',
              'Соблюдайте правила поездки: пристёгивайтесь, не отвлекайте водителя и не нарушайте ПДД.',
              'Оплату проводите по правилам сервиса: проверяйте способ оплаты и сохраняйте чек.',
              'При проблемах сразу обращайтесь в поддержку: фиксируйте опоздание, несоответствие авто, грубость или аварийную ситуацию в приложении.',
            ],
          },
        ],
      },
